  ...
  describe S256Point do
    ...
    describe '#sec' do
      ...
      context 'compressed' do
        let(:secret) { 5001 }
        let(:compressed) { true }
        let(:expected) { "\x03W\xA4\xF3h\x86\x8A\x8AmW)\x91\xE4\x84\xE6d\x81\x0F\xF1L\x05\xC0\xFA\x022u%\x11Q\xFE\x0ES\xD1".b }
        it { subject }
      end
    end
  end
